 ...
 * @since 1.0
 */
public class RedisSingleSession implements RedisSession {

    private static final String LOCK_SUCCEED = "OK";

    private final Jedis jedis;

    protected RedisSingleSession(Jedis jedis) {
        this.jedis = jedis;
    }
     ...
     */
    @Override
    public RedisSingleSession key(String key) {
     ...
     */
    @Override
    public RedisSingleSession expire(int seconds) {
        _seconds = seconds;
        return this;
    }
     ...
     */
    @Override
    public RedisSingleSession persist() {
        _seconds = -1;
        return this;
    }
     ...
     */
    @Override
    public RedisSingleSession set(String val) {
     ...
     */
    @Override
    public RedisSingleSession set(long val) {
     ...
     */
    @Override
    public RedisSingleSession hashSet(String field, String val) {
     ...
     */
    @Override
    public RedisSingleSession hashSet(String field, long val) {
     ...
     */
    @Override
    public RedisSingleSession hashSetAll(Map<? extends String, ? extends String> map) {
     ...
     */
    @Override
    public RedisSingleSession listAdd(String item) {
     ...
     */
    @Override
    public RedisSingleSession listAdd(long item) {
     ...
     */
    @Override
    public RedisSingleSession listSet(int index, String newValue) {
     ...
     */
    @Override
    public RedisSingleSession listDel(String item, int count) {
     ...
     */
    @Override
    public RedisSingleSession listDel(String item) {
        return listDel(item, 0);
    }

    @Override
    public RedisSingleSession listDelRange(Collection<? extends String> items) {
        Pipeline pip = jedis.pipelined();
    ...
    @Override
    public RedisSingleSession listAddRange(Collection<? extends String> items) {
        Pipeline pip = jedis.pipelined();
        for (String item : items) {
    ...
    @Override
    public RedisSingleSession setAddRange(Collection<String> items) {
        Pipeline pip = jedis.pipelined();
    ...
    //Sort set::
    @Override
    public RedisSingleSession zsetAdd(double score, String item) {
